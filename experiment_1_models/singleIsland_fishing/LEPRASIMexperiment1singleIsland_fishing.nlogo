...
globals [
  ...
  personmonths_experiment_island
  newcase
  newcasecontrol
  newcasecontact
  newcaseblanket
...
to go
  ...
  set-globals
  if ticks = 485 [
    singleIslandexperiment
    if fishing-on? = true [
      initiate-fishing
    ]
    set personmonths 0
    set personmonths_experiment_island 0
...
; intervention
  ...
  if ticks > 485[
    ...
    set personmonths_experiment_island personmonths_experiment_island + count people with [stage != "symptomatic" and myIsland = 2]
;    if ticks < 531 [
